        ...
        public IActionResult RegistroUsuario(Ingenieros Ingeniero)
        {
            ...
            try
            {
                using (var conexion = bd.establecerConexion())
                {
                    ...
                    "VALUES (@Nombre, @Apellido, @TipoDocumento, @NumeroDocumento, @Correo, @Contraseña, @FechaNacimiento, @Telefono)RETURNING id_usuario";
                ...
                return View("~/Views/IngCompletarPerfil/Index.cshtml");
